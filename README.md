...
- LOCK: foi utilizado em parceira com o **ROLLBACK** e tem por objeitvo garantir que apenas uma thread ou processo possa acessar um recurso compartilhado por vez, como por exemplo o banco de dados e algumas rotas da API Rest, fazendo assim com que não gere conflitos ou perca da confiabilidade dos dados durante as operações afim de garantir um sistema confiável.
...
<p align="center">
  <img src="https://github.com/Pegasus77-Adriel/pb2_main/blob/main/tela_bancaria.png">
</p>
